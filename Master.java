...
//server socket gia tous workers kai o master ksekinaei connection me ta server
    private ServerSocket serverSocketApp;
    private ServerSocket serverSocketWorker;
    private ServerSocket serverSocketWorker0;
    private ServerSocket serverSocketWorker1;
    private ServerSocket serverSocketWorker2;
    ...
    private void openServerWorker() throws IOException {
        ...
        serverSocketWorker0 = new ServerSocket(1000);
        serverSocketWorker1 = new ServerSocket(2000);
        serverSocketWorker2 = new ServerSocket(3000);
    ...
    private void waitForClientWorker0() throws IOException {
        clientSocketWorker0 = serverSocketWorker0.accept();
    ...
    private void waitForClientWorker1() throws IOException {
        clientSocketWorker1 = serverSocketWorker1.accept();
    ...
    private void waitForClientWorker2() throws IOException {
        clientSocketWorker2 = serverSocketWorker2.accept();
...
//na ta valw se ena array prin to steilw
        while (start < size) {
    ...
    public void closeServers() {
        try {
            ...
            if (serverSocketWorker0 != null) {
                serverSocketWorker0.close();
            }
            if (serverSocketWorker1 != null) {
                serverSocketWorker1.close();
            }
            if (serverSocketWorker2 != null) {
                serverSocketWorker2.close();
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
