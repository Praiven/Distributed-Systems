...
//                    System.out.println("Average distance: " + df.format(totalDT) + " km");
//                    System.out.println("Average elevation: " + df.format(totalET) + " m");
//                    System.out.println("Average time: " + df.format(totalTT) + " minutes");
//                    System.out.println("Average speed for all runs: " + df.format(totalAT) + " km/h\n");
//
//                    System.out.println("\n ===================================== \n");

                    inputObject = in.readObject();
                    double totalDTA = (double) inputObject;
                    inputObject = in.readObject();
                    double totalETA = (double) inputObject;
                    inputObject = in.readObject();
                    double totalTTA = (double) inputObject;
                    inputObject = in.readObject();
                    double totalATA = (double) inputObject;
                    System.out.println(user + " your total statistics compared to others: ");
                    System.out.println("Your average distance: " + df.format(totalDT) + " km");
                    System.out.println("Your average elevation: " + df.format(totalET) + " m");
                    System.out.println("Your average time: " + df.format(totalTT) + " minutes");
                    System.out.println("Your average speed for all runs: " + df.format(totalAT) + " km/h");
                    System.out.println("-------------------------------------------------------------");
                    System.out.println("All users' average distance: " + df.format(totalDTA) + " km");
                    System.out.println("All users' elevation: " + df.format(totalETA) + " m");
                    System.out.println("All users' time: " + df.format(totalTTA) + " minutes");
                    System.out.println("All users' speed for all runs: " + df.format(totalATA) + " km/h\n");
