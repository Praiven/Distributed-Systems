...
public class Worker extends Thread {
    ...
    public void run() {
        try {
            ...
            while (true) {
                ...
                splitDataType();
                System.out.println(elemWpt + "elemwpt \n");
                System.out.println(elemEle + "elemele  \n");
    ...
    public static void main(String[] args) throws ParseException, IOException {
        ...
        Worker worker0 = new Worker("localhost", 1000, "worker0");
        Thread worker0Thread = new Thread(worker0);
        worker0Thread.start();

        Worker worker1 = new Worker("localhost", 2000, "worker1");
        Thread worker1Thread = new Thread(worker1);
        worker1Thread.start();

        Worker worker2 = new Worker("localhost", 3000, "worker2");
